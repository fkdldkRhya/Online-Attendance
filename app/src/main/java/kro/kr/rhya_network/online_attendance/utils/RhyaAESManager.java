...
public class RhyaAESManager {
    ...
    public RhyaAESManager(Context context) {
        ...
        RhyaSharedPreferences rhyaSharedPreferences = new RhyaSharedPreferences();

        // 암호화 키 데이터 가져오기
        String getValue = rhyaSharedPreferences.getStringNoAES(rhyaSharedPreferences.SHARED_PREFERENCES_AES_KEY, context);
        if (getValue.equals(rhyaSharedPreferences.SHARED_PREFERENCES_DEFAULT_RETURN)) {
            // 등록된 키 없음
            // 키 생성
     ...
     * @return 암호화된 텍스트
     */
    public String aesEncode(String str) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
     ...
     * @return 복호화된 텍스트
     */
    public String aesDecode(String str) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
    ...
    private String getRandomKey() {
        ...
        // 암호화 기본 베이스 키
        String AES_KEY_GEN_BASE_VALUE = "zeB4t95kYCTAz4erCnrCHGHcbewY3awR";
